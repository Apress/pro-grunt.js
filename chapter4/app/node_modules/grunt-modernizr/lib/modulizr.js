...
(function(global){
  var Modulizr = {
    _dependencies: {
      ...
      'flexboxlegacy'  : ['domprefixes', 'testprop', 'testallprops'],
    ...
    ize: function(source, tests, autoCB){
      ...
      // Mark the tests
      js_notests = source.split("\n").map(function (line) {
        return line.replace(/tests\['(.*)'\]/g, function($0, $1) {
          testStack[testStack.length] = {"code":$0.trim(), "name": $1};
          return 'TEST__'+$1+'__';
        });
      }).join("\n");
